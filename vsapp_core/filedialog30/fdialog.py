...
class FileDialog:
    ...
    def __init__(
        ...
        # texture loading
        diwidth, diheight, dichannels, didata = dpg.load_image("vsapp_core/filedialog30/images/document.png")
        afiwidth, afiheight, afichannels, afidata = dpg.load_image("vsapp_core/filedialog30/images/add_folder.png")
        afwidth, afheight, afchannels, afdata = dpg.load_image("vsapp_core/filedialog30/images/add_file.png")
        mfwidth, mfheight, mfchannels, mfdata = dpg.load_image("vsapp_core/filedialog30/images/mini_folder.png")
        fiwidth, fiheight, fichannels, fidata = dpg.load_image("vsapp_core/filedialog30/images/folder.png")
        mdwidth, mdheight, mdchannels, mddata = dpg.load_image("vsapp_core/filedialog30/images/mini_document.png")
        mewidth, meheight, mechannels, medata = dpg.load_image("vsapp_core/filedialog30/images/mini_error.png")
        rwidth, rheight, rchannels, rdata = dpg.load_image("vsapp_core/filedialog30/images/refresh.png")
        hdwidth, hdheight, hdchannels, hddata = dpg.load_image("vsapp_core/filedialog30/images/hd.png")
        pwidth, pheight, pchannels, pdata = dpg.load_image("vsapp_core/filedialog30/images/picture.png")
        bpwidth, bpheight, bpchannels, bpdata = dpg.load_image("vsapp_core/filedialog30/images/big_picture.png")
        pfwidth, pfheight, pfchannels, pfdata = dpg.load_image("vsapp_core/filedialog30/images/picture_folder.png")
        dwidth, dheight, dchannels, ddata = dpg.load_image("vsapp_core/filedialog30/images/desktop.png")
        vwidth, vheight, vchannels, vdata = dpg.load_image("vsapp_core/filedialog30/images/videos.png")
        mwidth, mheight, mchannels, mdata = dpg.load_image("vsapp_core/filedialog30/images/music.png")
        dfwidth, dfheight, dfchannels, dfdata = dpg.load_image("vsapp_core/filedialog30/images/downloads.png")
        dcfwidth, dcfheight, dcfchannels, dcfdata = dpg.load_image("vsapp_core/filedialog30/images/documents.png")
        swidth, sheight, schannels, sdata = dpg.load_image("vsapp_core/filedialog30/images/search.png")
        bwidth, bheight, bchannels, bdata = dpg.load_image("vsapp_core/filedialog30/images/back.png")
        cwidth, cheight, cchannels, cdata = dpg.load_image("vsapp_core/filedialog30/images/c.png")
        gwidth, gheight, gchannels, gdata = dpg.load_image("vsapp_core/filedialog30/images/gears.png")
        mnwidth, mnheight, mnchannels, mndata = dpg.load_image("vsapp_core/filedialog30/images/music_note.png")
        nwidth, nheight, nchannels, ndata = dpg.load_image("vsapp_core/filedialog30/images/note.png")
        owidth, oheight, ochannels, odata = dpg.load_image("vsapp_core/filedialog30/images/object.png")
        pywidth, pyheight, pychannels, pydata = dpg.load_image("vsapp_core/filedialog30/images/python.png")
        scwidth, scheight, scchannels, scdata = dpg.load_image("vsapp_core/filedialog30/images/script.png")
        vfwidth, vfheight, vfchannels, vfdata = dpg.load_image("vsapp_core/filedialog30/images/video.png")
        lwidth, lheight, lchannels, ldata = dpg.load_image("vsapp_core/filedialog30/images/link.png")
        uwidth, uheight, uchannels, udata = dpg.load_image("vsapp_core/filedialog30/images/url.png")
        vewidth, veheight, vechannels, vedata = dpg.load_image("vsapp_core/filedialog30/images/vector.png")
        zwidth, zheight, zchannels, zdata = dpg.load_image("vsapp_core/filedialog30/images/zip.png")
        awidth, aheight, achannels, adata = dpg.load_image("vsapp_core/filedialog30/images/app.png")
        iwidth, iheight, ichannels, idata = dpg.load_image("vsapp_core/filedialog30/images/iso.png")
            ...
            with dpg.group(horizontal=True):
                ...
                with dpg.child_window(tag="shortcut_menu", width=200, show=self.show_shortcuts_menu, height=-info_px):
                    ...
                    if desktop==self.default_path:
                        ...
                        music = get_directory_path("Music")
                        ...
                        music = get_directory_path("Muzyka")
                    ...
                    with dpg.group(horizontal=True):
                        ...
                        dpg.add_menu_item(label="Music", callback=lambda: chdir(music))
                    with dpg.group(horizontal=True):
